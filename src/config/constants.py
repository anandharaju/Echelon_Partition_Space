...
T1_TRAIN_BATCH_SIZE = 4
T2_TRAIN_BATCH_SIZE = 1
...
#  DATA SOURCE
MAX_FILE_SIZE_LIMIT = 10240 # 2**20  # 204800
MAX_FILE_COUNT_LIMIT = None
CONV_WINDOW_SIZE = 500
CONV_STRIDE_SIZE = 500
PROJECT_BASE_PATH = '/home/vivo/Echelon_Linux'
ALL_FILE = PROJECT_BASE_PATH + '/data/xs.csv'  # small_pkl_1_1.csv'
